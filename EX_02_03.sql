...
-- SELECT * FROM people INNER JOIN phones ON  people.person_id = phones.person_id INNER JOIN addresses ON people.person_id = addresses.person_id;
...
SELECT people.name, phones.number, addresses.street FROM people INNER JOIN phones ON  people.person_id = phones.person_id INNER JOIN addresses ON people.person_id = addresses.person_id WHERE people.name = 'John'